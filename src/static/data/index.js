import movix1 from '../img/project/movix/1.png';
import movix2 from '../img/project/movix/2.png';
import movix3 from '../img/project/movix/3.png';
import movix4 from '../img/project/movix/4.png';
import movix5 from '../img/project/movix/5.png';
import movix6 from '../img/project/movix/6.png';
import movix7 from '../img/project/movix/7.png';
...
export const projects = [
  {
    id: 0,
    name: 'Movix',
    images: [movix1, movix2, movix3, movix4, movix5, movix6, movix7],
    desc: 'A small project using redux library and redux-toolkit with reactjs.',
    created: 'Jul 6, 2023',
    role: 'FE Developer',
    frontend: ['React', 'SCSS', 'Redux', 'Redux-toolkit'],
    backend: null,
    tags: ['react', 'scss', 'redux', 'redux-toolkit', 'ui/ux', 'responsive', 'web design'],
